...
favourites:
  ...
  - name: Kazu Izakaya
    ...
    area: Te Aro
    badge: Must book
    description: One of Janan and Ryan's favourite impromptu date night spots. She loves it because it reminds her of Tokyo. He loves it because it's small, cozy, charming, and has good food.
    image: https://neatplaces.co.nz/cdn-cgi/image/format=auto,fit=cover,height=425,width=650//media/uploads/places/place/kazu_yakitori__sake_bar/Kazu-Yakitori-dining-room.jpg
    imageAlt: Interior photo of Kazu Izakaya Bar
  - name: KC Cafe
    category: Food & drink
  ...
  - name: Te Papa Tongarewa
    ...
    area: Waterfront
    description: New Zealand’s national museum, covering natural history, art, Pacific cultures and Māori taonga. The main museum is free.
    image: "https://images.unsplash.com/photo-1564399579883-451a5d44ec08?auto=format&fit=crop&w=900&q=85"
    imageAlt: Museum gallery with large-scale exhibits
  - name: Wellington Cable Car & Botanic Garden
    category: Things to do
    area: Kelburn
    description: Catch the cable car for harbour views, then walk down through the Botanic Garden. Janan and Ryan got engaged at the Norwood Rose Garden.
    image: "https://images.unsplash.com/photo-1500534623283-312aade485b7?auto=format&fit=crop&w=900&q=85"
    imageAlt: Green botanical garden overlooking a city
  ...
  - name: Martinborough
    ...
    area: Wairarapa
    description: Wine country over the hill, known for Pinot Noir, boutique cellar doors and long vineyard lunches. Consider staying overnight or booking a wine tour.
    image: "https://images.unsplash.com/photo-1506377247377-2a5b3b417ebb?auto=format&fit=crop&w=900&q=85"
    imageAlt: Rows of vines in a sunny vineyard
  - name: Greytown
    category: Further afield
    area: Wairarapa
